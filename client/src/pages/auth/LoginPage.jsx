...
import { assemblerTelephone, validerSuffixeTelephone } from '../../lib/utils'
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    setError('')
    if (!validerSuffixeTelephone(telSuffix)) {
      setTelError('Entrez les 8 chiffres après 01')
      return
    }
    setTelError('')
    const res = await login(assemblerTelephone(telSuffix), mot_de_passe)
        ...
        <div className="card p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <PhoneInput suffix={telSuffix} onChange={setTelSuffix} error={telError} />
            </div>
